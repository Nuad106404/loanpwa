...
export namespace Prisma {
  ...
  */
    ...
    model: {
      ...
      LoanApplication: {
        ...
        operations: {
          ...
          findRaw: {
            args: Prisma.LoanApplicationFindRawArgs<ExtArgs>
            result: JsonObject
          }
          aggregateRaw: {
            args: Prisma.LoanApplicationAggregateRawArgs<ExtArgs>
            result: JsonObject
          }
          count: {
  ...
  export type UserOmit<ExtArgs extends $Extensions.InternalArgs = $Extensions.DefaultArgs> = $Extensions.GetOmit<"id" | "firstName" | "lastName" | "phone" | "password" | "createdAt" | "updatedAt", ExtArgs["result"]["user"]>
  ...
  export type LoanApplicationMinAggregateOutputType = {
    ...
    familySubdistrict: string | null
    familyDistrict: string | null
    familyProvince: string | null
    familyZipCode: string | null
  ...
  export type LoanApplicationCountAggregateOutputType = {
    ...
    familyName: number
    familyPhone: number
    familySubdistrict: number
    familyDistrict: number
    familyProvince: number
    familyZipCode: number
    relationship: number
    status: number
    createdAt: number
    updatedAt: number
  ...
  export type LoanApplicationSelect<ExtArgs extends $Extensions.InternalArgs = $Extensions.DefaultArgs> = $Extensions.GetSelect<{
    ...
    familyName?: boolean
    familyPhone?: boolean
    familySubdistrict?: boolean
    familyDistrict?: boolean
    familyProvince?: boolean
    familyZipCode?: boolean
  ...
  export type LoanApplicationOmit<ExtArgs extends $Extensions.InternalArgs = $Extensions.DefaultArgs> = $Extensions.GetOmit<"id" | "applicationNumber" | "userId" | "firstName" | "lastName" | "phone" | "dateOfBirth" | "nationalId" | "idCardFrontUrl" | "idCardBackUrl" | "selfieWithIdUrl" | "signatureUrl" | "subdistrict" | "district" | "province" | "zipCode" | "income" | "employmentStatus" | "loanPurpose" | "bankName" | "accountNumber" | "accountName" | "familyName" | "familyPhone" | "familySubdistrict" | "familyDistrict" | "familyProvince" | "familyZipCode" | "relationship" | "status" | "createdAt" | "updatedAt", ExtArgs["result"]["loanApplication"]>
  ...
  export interface LoanApplicationDelegate<ExtArgs extends $Extensions.InternalArgs = $Extensions.DefaultArgs, GlobalOmitOptions = {}> {
    ...
    /**
     * Find zero or more LoanApplications that matches the filter.
     * @param {LoanApplicationFindRawArgs} args - Select which filters you would like to apply.
     * @example
     * const loanApplication = await prisma.loanApplication.findRaw({
     *   filter: { age: { $gt: 25 } }
     * })
     */
    findRaw(args?: LoanApplicationFindRawArgs): Prisma.PrismaPromise<JsonObject>

    /**
     * Perform aggregation operations on a LoanApplication.
     * @param {LoanApplicationAggregateRawArgs} args - Select which aggregations you would like to apply.
     * @example
     * const loanApplication = await prisma.loanApplication.aggregateRaw({
     *   pipeline: [
     *     { $match: { status: "registered" } },
     *     { $group: { _id: "$country", total: { $sum: 1 } } }
     *   ]
     * })
     */
    aggregateRaw(args?: LoanApplicationAggregateRawArgs): Prisma.PrismaPromise<JsonObject>
  ...
  interface LoanApplicationFieldRefs {
    ...
    readonly dateOfBirth: FieldRef<"LoanApplication", 'DateTime'>
    readonly nationalId: FieldRef<"LoanApplication", 'String'>
    readonly idCardFrontUrl: FieldRef<"LoanApplication", 'String'>
    readonly idCardBackUrl: FieldRef<"LoanApplication", 'String'>
    readonly selfieWithIdUrl: FieldRef<"LoanApplication", 'String'>
    readonly signatureUrl: FieldRef<"LoanApplication", 'String'>
    readonly subdistrict: FieldRef<"LoanApplication", 'String'>
    readonly district: FieldRef<"LoanApplication", 'String'>
    readonly province: FieldRef<"LoanApplication", 'String'>
    readonly zipCode: FieldRef<"LoanApplication", 'String'>
    readonly income: FieldRef<"LoanApplication", 'Float'>
    readonly employmentStatus: FieldRef<"LoanApplication", 'String'>
    ...
    readonly accountName: FieldRef<"LoanApplication", 'String'>
    readonly familyName: FieldRef<"LoanApplication", 'String'>
    readonly familyPhone: FieldRef<"LoanApplication", 'String'>
    readonly familySubdistrict: FieldRef<"LoanApplication", 'String'>
    readonly familyDistrict: FieldRef<"LoanApplication", 'String'>
    readonly familyProvince: FieldRef<"LoanApplication", 'String'>
    readonly familyZipCode: FieldRef<"LoanApplication", 'String'>
    readonly relationship: FieldRef<"LoanApplication", 'String'>
  ...
  /**
   * LoanApplication findRaw
   */
  export type LoanApplicationFindRawArgs<ExtArgs extends $Extensions.InternalArgs = $Extensions.DefaultArgs> = {
    /**
     * The query predicate filter. If unspecified, then all documents in the collection will match the predicate. ${@link https://docs.mongodb.com/manual/reference/operator/query MongoDB Docs}.
     */
    filter?: InputJsonValue
  ...
  /**
   * LoanApplication aggregateRaw
   */
  export type LoanApplicationAggregateRawArgs<ExtArgs extends $Extensions.InternalArgs = $Extensions.DefaultArgs> = {
    /**
     * An array of aggregation stages to process and transform the document stream via the aggregation pipeline. ${@link https://docs.mongodb.com/manual/reference/operator/aggregation-pipeline MongoDB Docs}.
     */
    pipeline?: InputJsonValue[]
  ...
  export type LoanApplicationWhereInput = {
    ...
    dateOfBirth?: DateTimeFilter<"LoanApplication"> | Date | string
    nationalId?: StringFilter<"LoanApplication"> | string
    idCardFrontUrl?: StringNullableFilter<"LoanApplication"> | string | null
    idCardBackUrl?: StringNullableFilter<"LoanApplication"> | string | null
    selfieWithIdUrl?: StringNullableFilter<"LoanApplication"> | string | null
    signatureUrl?: StringNullableFilter<"LoanApplication"> | string | null
    subdistrict?: StringFilter<"LoanApplication"> | string
    district?: StringFilter<"LoanApplication"> | string
    province?: StringFilter<"LoanApplication"> | string
    zipCode?: StringFilter<"LoanApplication"> | string
    income?: FloatFilter<"LoanApplication"> | number
    employmentStatus?: StringFilter<"LoanApplication"> | string
    ...
    accountName?: StringFilter<"LoanApplication"> | string
    familyName?: StringFilter<"LoanApplication"> | string
    familyPhone?: StringFilter<"LoanApplication"> | string
    familySubdistrict?: StringFilter<"LoanApplication"> | string
    familyDistrict?: StringFilter<"LoanApplication"> | string
    familyProvince?: StringFilter<"LoanApplication"> | string
    familyZipCode?: StringFilter<"LoanApplication"> | string
    relationship?: StringFilter<"LoanApplication"> | string
  ...
  export type LoanApplicationOrderByWithRelationInput = {
    ...
    familySubdistrict?: SortOrder
    familyDistrict?: SortOrder
    familyProvince?: SortOrder
    familyZipCode?: SortOrder
  ...
  export type LoanApplicationScalarWhereWithAggregatesInput = {
    ...
    dateOfBirth?: DateTimeWithAggregatesFilter<"LoanApplication"> | Date | string
    nationalId?: StringWithAggregatesFilter<"LoanApplication"> | string
    idCardFrontUrl?: StringNullableWithAggregatesFilter<"LoanApplication"> | string | null
    idCardBackUrl?: StringNullableWithAggregatesFilter<"LoanApplication"> | string | null
    selfieWithIdUrl?: StringNullableWithAggregatesFilter<"LoanApplication"> | string | null
    signatureUrl?: StringNullableWithAggregatesFilter<"LoanApplication"> | string | null
    subdistrict?: StringWithAggregatesFilter<"LoanApplication"> | string
    district?: StringWithAggregatesFilter<"LoanApplication"> | string
    province?: StringWithAggregatesFilter<"LoanApplication"> | string
    zipCode?: StringWithAggregatesFilter<"LoanApplication"> | string
    income?: FloatWithAggregatesFilter<"LoanApplication"> | number
    employmentStatus?: StringWithAggregatesFilter<"LoanApplication"> | string
    ...
    accountName?: StringWithAggregatesFilter<"LoanApplication"> | string
    familyName?: StringWithAggregatesFilter<"LoanApplication"> | string
    familyPhone?: StringWithAggregatesFilter<"LoanApplication"> | string
    familySubdistrict?: StringWithAggregatesFilter<"LoanApplication"> | string
    familyDistrict?: StringWithAggregatesFilter<"LoanApplication"> | string
    familyProvince?: StringWithAggregatesFilter<"LoanApplication"> | string
    familyZipCode?: StringWithAggregatesFilter<"LoanApplication"> | string
    relationship?: StringWithAggregatesFilter<"LoanApplication"> | string
  ...
  export type LoanApplicationUpdateInput = {
    ...
    selfieWithIdUrl?: NullableStringFieldUpdateOperationsInput | string | null
    ...
    familyPhone?: StringFieldUpdateOperationsInput | string
    familySubdistrict?: StringFieldUpdateOperationsInput | string
    familyDistrict?: StringFieldUpdateOperationsInput | string
    familyProvince?: StringFieldUpdateOperationsInput | string
    familyZipCode?: StringFieldUpdateOperationsInput | string
